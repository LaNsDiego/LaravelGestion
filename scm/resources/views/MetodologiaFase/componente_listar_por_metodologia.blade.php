    ...
    <div class="tab-pane fade active show" id="Fase1">
        <div class="pt-3">
            ...
            <div class="animated-checkbox box-elemento">
                <label>
                    <input name="Inicio[]" value="elemento1" type="checkbox"><span class="label-text">Elemento</span>
                </label>
            </div>
            <!-- checkbox -->
            <!-- checkbox -->
            <div class="animated-checkbox box-elemento">
                <label>
                    <input name="Inicio[]" value="elemento2" type="checkbox"><span class="label-text">Elemento</span>
                </label>
            </div>
            <!-- checkbox -->
            <!-- checkbox -->
            <div class="animated-checkbox box-elemento">
                <label>
                    <input name="Inicio[]" value="elemento3" type="checkbox"><span class="label-text">Elemento</span>
                </label>
            </div>
            <!-- checkbox -->
            <!-- checkbox -->
            <div class="animated-checkbox box-elemento">
                <label>
                    <input name="Inicio[]" value="elemento4" type="checkbox"><span class="label-text">Elemento</span>
                </label>
            </div>
            <!-- checkbox -->
            <!-- checkbox -->
            <div class="animated-checkbox box-elemento">
                <label>
                    <input name="Inicio[]" value="elemento5" type="checkbox"><span class="label-text">Elemento</span>
                </label>
            </div>
            <!-- checkbox -->
            <!-- checkbox -->
            <div class="animated-checkbox box-elemento">
                <label>
                    <input name="Inicio[]" value="elemento6" type="checkbox"><span class="label-text">Elemento</span>
                </label>
            </div>
            <!-- checkbox -->
        </div>
